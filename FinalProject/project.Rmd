...
```{r,echo=F}
ru <- read.table("Results/FuncAnnotChart_rna_up.tsv", header = T, sep = "\t")
ru$Term
```
...
```
```{r,echo=F}
rd <- read.table("Results/FuncAnnotChart_rna_do.tsv", header = T, sep = "\t")
rd$Term
```
...
```
```{r,echo=F}
pu <- read.table("Results/FuncAnnotChart_pro_up.tsv", header = T, sep = "\t")
pu$Term
```
...
```
```{r,echo=F}
pd <- read.table("Results/FuncAnnotChart_pro_do.tsv", header = T, sep = "\t")
pd$Term
```
